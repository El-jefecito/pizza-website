...
function Contact() {
  ...
  return (
    <section
      ...
      } w-full lg:px-20 px-10 lg:py-20 py-10 h-fit flex flex-col justify-center items-center bg-cover bg-center`}
    ...
    >
      <div className="lg:w-[80%] w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-10">
        ...
        >
          ...
          <p1 className="text-center text-lg dark:text-white text-slate-800">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Suscipit
            accusantium doloribus eligendi voluptates! Hic ipsam tenetur.
          </p1>
